...
class LicenseEnforcerTest {
	...
	// -- LockedAction.fromName --

	@Test
	fun `LockedAction fromName returns correct action for CREATE_VAULT`() {
		val action = LicenseEnforcer.LockedAction.fromName("CREATE_VAULT")

		assertNotNull(action)
		assertTrue(action == LicenseEnforcer.LockedAction.CREATE_VAULT)
	}

	@Test
	fun `LockedAction fromName returns correct action for UPLOAD_FILES`() {
		val action = LicenseEnforcer.LockedAction.fromName("UPLOAD_FILES")

		assertNotNull(action)
		assertTrue(action == LicenseEnforcer.LockedAction.UPLOAD_FILES)
	}

	@Test
	fun `LockedAction fromName returns correct action for CREATE_FOLDER`() {
		val action = LicenseEnforcer.LockedAction.fromName("CREATE_FOLDER")

		assertNotNull(action)
		assertTrue(action == LicenseEnforcer.LockedAction.CREATE_FOLDER)
	}

	@Test
	fun `LockedAction fromName returns correct action for CREATE_TEXT_FILE`() {
		val action = LicenseEnforcer.LockedAction.fromName("CREATE_TEXT_FILE")

		assertNotNull(action)
		assertTrue(action == LicenseEnforcer.LockedAction.CREATE_TEXT_FILE)
	}

	@Test
	fun `LockedAction fromName returns correct action for SHARE_NODE`() {
		val action = LicenseEnforcer.LockedAction.fromName("SHARE_NODE")

		assertNotNull(action)
		assertTrue(action == LicenseEnforcer.LockedAction.SHARE_NODE)
	}

	@Test
	fun `LockedAction fromName returns correct action for RENAME_NODE`() {
		val action = LicenseEnforcer.LockedAction.fromName("RENAME_NODE")

		assertNotNull(action)
		assertTrue(action == LicenseEnforcer.LockedAction.RENAME_NODE)
	}

	@Test
	fun `LockedAction fromName returns correct action for MOVE_NODE`() {
		val action = LicenseEnforcer.LockedAction.fromName("MOVE_NODE")

		assertNotNull(action)
		assertTrue(action == LicenseEnforcer.LockedAction.MOVE_NODE)
	}

	@Test
	fun `LockedAction fromName returns correct action for DELETE_NODE`() {
		val action = LicenseEnforcer.LockedAction.fromName("DELETE_NODE")

		assertNotNull(action)
		assertTrue(action == LicenseEnforcer.LockedAction.DELETE_NODE)
	}

	@Test
	fun `LockedAction fromName returns null for unknown name`() {
		val action = LicenseEnforcer.LockedAction.fromName("UNKNOWN_ACTION")
	...
	fun `LockedAction fromName returns null for null input`() {
		val action = LicenseEnforcer.LockedAction.fromName(null)
	...
	@Test
	fun `LockedAction fromName is case-sensitive and returns null for lowercase`() {
		val action = LicenseEnforcer.LockedAction.fromName("create_vault")
	...
	@Test
	fun `LockedAction fromName is case-sensitive and returns null for mixed case`() {
		val action = LicenseEnforcer.LockedAction.fromName("Create_Vault")
	...
	@Test
	fun `LockedAction name roundtrip via fromName returns the same action`() {
		LicenseEnforcer.LockedAction.values().forEach { originalAction ->
			val retrieved = LicenseEnforcer.LockedAction.fromName(originalAction.name)
			assertNotNull(retrieved)
			assertTrue(retrieved == originalAction)
		}
	}
}